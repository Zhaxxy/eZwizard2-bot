...
async def patch_memory_for_saves_900(ps4: PS4Debug) -> MemoryIsPatched:
...
async def mount_save(ps4: PS4Debug, mem: MemoryIsPatched, user_id: int,cusa_game_id: str, savedir: str) -> SceSaveDataMountResult:
    ...
    async with ps4.memory(mem.pid,size_of_SceSaveDataDirName + 0x10 + 0x41) as memory1:
        ...
        mount = SceSaveDataMount(userId = user_id, dirName = dirNameAddr, blocks = 32768, mountMode = 0x8 | 0x2, fingerprint = fingerprintAddr, titleId = titleIdAddr)
